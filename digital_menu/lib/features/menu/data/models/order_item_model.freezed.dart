...
mixin _$OrderItemModel {
 ...
 String get dishId; String get name; double get price; int get quantity;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderItemModel&&(identical(other.dishId, dishId) || other.dishId == dishId)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
...
@override
String toString() {
  return 'OrderItemModel(dishId: $dishId, name: $name, price: $price, quantity: $quantity)';
}
...
@useResult
$Res call({
 String dishId, String name, double price, int quantity
});
...
/// Create a copy of OrderItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dishId = null,Object? name = null,Object? price = null,Object? quantity = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String dishId,  String name,  double price,  int quantity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderItemModel() when $default != null:
return $default(_that.dishId,_that.name,_that.price,_that.quantity);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String dishId,  String name,  double price,  int quantity)  $default,) {final _that = this;
switch (_that) {
case _OrderItemModel():
return $default(_that.dishId,_that.name,_that.price,_that.quantity);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String dishId,  String name,  double price,  int quantity)?  $default,) {final _that = this;
switch (_that) {
case _OrderItemModel() when $default != null:
return $default(_that.dishId,_that.name,_that.price,_that.quantity);case _:
  return null;
...
class _OrderItemModel extends OrderItemModel {
  const _OrderItemModel({required this.dishId, required this.name, required this.price, required this.quantity}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderItemModel&&(identical(other.dishId, dishId) || other.dishId == dishId)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
...
/// Create a copy of OrderItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dishId = null,Object? name = null,Object? price = null,Object? quantity = null,}) {
